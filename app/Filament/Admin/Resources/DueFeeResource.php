...
use App\Filament\Admin\Resources\DueFeeResource\Pages;
...
class DueFeeResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Due Fee';
    protected static ?string $pluralModelLabel = 'Due Fees';
                ...
                Section::make()
                    ->schema([
                        ...
                        Forms\Components\Select::make('admission_course_id')
                            ->label('Course')
                            ->options(\App\Models\Course::pluck('course_name', 'id'))
                            ->disabled()
                            ->required(),
